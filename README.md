...
Description : le programme analyse les données fournies pour s'assuréer qu'elles sont valide, puis retourne ce qu'elles signifient de manière compréhensible pour l'humain.
